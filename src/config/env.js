...
const env = {
    ...
    trunkAiDisconnectToneCadenceEnabled: toBoolean(process.env.TRUNK_AI_DISCONNECT_TONE_CADENCE_ENABLED, true),
    trunkAiDisconnectToneDirectCallbackEnabled: toBoolean(process.env.TRUNK_AI_DISCONNECT_TONE_DIRECT_CALLBACK_ENABLED, true),
    trunkAiDisconnectToneBurstsRequired: toNumber(process.env.TRUNK_AI_DISCONNECT_TONE_BURSTS_REQUIRED, 2),
    trunkAiDisconnectToneBurstMinMs: toNumber(process.env.TRUNK_AI_DISCONNECT_TONE_BURST_MIN_MS, 300),
    trunkAiDisconnectToneGapMinMs: toNumber(process.env.TRUNK_AI_DISCONNECT_TONE_GAP_MIN_MS, 180),
    trunkAiDisconnectToneGapMaxMs: toNumber(process.env.TRUNK_AI_DISCONNECT_TONE_GAP_MAX_MS, 1800),
    trunkAiDisconnectToneWindowMs: toNumber(process.env.TRUNK_AI_DISCONNECT_TONE_WINDOW_MS, 6000),
    trunkAiDisconnectToneFrequencyToleranceHz: toNumber(process.env.TRUNK_AI_DISCONNECT_TONE_FREQUENCY_TOLERANCE_HZ, 60),
